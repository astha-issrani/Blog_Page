...
const styles = `
  ...
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  html, body, #root { margin: 0; padding: 0; width: 100%; background: #fff; overflow-x: hidden; }
  ...
  .wf-action-left, .wf-action-right {
    display: flex;
    align-items: center;
    gap: 20px;
  }
  ...
  .wf-icon-btn:hover .wf-clap-ring {
  ...
  .wf-hero {
    ...
    margin-bottom: 10px;
    aspect-ratio: 16 / 7.5;
    background: linear-gradient(135deg, #0d1117 0%, #161b29 45%, #1a1040 75%, #2d1b5e 100%);
    display: flex;
    align-items: center;
    justify-content: center;
  }
  ...
  @media (max-width: 900px) {
    ...
    .wf-body blockquote p { font-size: 17px; }
    .wf-cards-grid { grid-template-columns: 1fr; gap: 24px; }
    .wf-mobile-bar { display: flex; }
    .wf-nav-pub { display: none; }
    .wf-hero-ui { width: 78%; }
    .wf-inline-ui { width: 90%; }
    .wf-hero { aspect-ratio: 16/8; }
  }

  @media (max-width: 480px) {
    .wf-nav { padding: 0 16px; }
    .wf-main { padding: 24px 16px 80px; }
    .wf-title { font-size: 26px; line-height: 34px; }
    .wf-subtitle { font-size: 16px; line-height: 24px; }
    .wf-body p { font-size: 17px; line-height: 28px; }
    .wf-avatar { width: 38px; height: 38px; font-size: 15px; }
    .wf-hero-ui { width: 88%; }
    .wf-hero-row { font-size: 10px; padding: 7px 10px; }
    .wf-badge { font-size: 9px; padding: 2px 7px; }
    .wf-logo { font-size: 22px; }
    .wf-getstarted { padding: 6px 12px; font-size: 13px; }
    .wf-signin { font-size: 13px; }
  }
`;
...
function ClapIcon({ active }) {
  return (
    <svg width="16" height="16" viewBox="0 0 24 24" fill={active ? "#fff" : "currentColor"}>
      <path d="M13.5 2.25a.75.75 0 01.75.75v3a.75.75 0 01-1.5 0V3a.75.75 0 01.75-.75zM10 4.5a.75.75 0 000 1.5h3a.75.75 0 000-1.5H10zM6.932 6.568a.75.75 0 011.06 0l2.122 2.122a.75.75 0 01-1.06 1.06L6.932 7.628a.75.75 0 010-1.06zM17.303 8.75a.75.75 0 00-1.06 1.06l2.121 2.122a.75.75 0 001.06-1.06L17.303 8.75z" />
    ...
    <div className="wf-hero-ui">
      ...
      <div className="wf-hero-body">
        <div className="wf-hero-row">
          <span>The Art of Saying Less</span>
          <span className="wf-badge wf-badge-green">Scheduled</span>
        </div>
        <div className="wf-hero-row">
          <span>How I Built a SaaS in 30 Days</span>
          <span className="wf-badge wf-badge-dark">May 14 · 9:00 AM</span>
        </div>
        <div className="wf-hero-row">
          <span>Why Generalism is a Superpower</span>
          <span className="wf-badge wf-badge-grey">Draft</span>
        </div>
        <div className="wf-hero-row">
  ...
  return (
    <div className="wf-inline-ui">
      ...
      <div className="wf-inline-row">
        <span className="wf-inline-row-name">The Art of Saying Less</span>
        <span className="wf-schedule-pill set">May 13 · 8:00 AM ✓</span>
      </div>
      <div className="wf-inline-row">
        <span className="wf-inline-row-name">How I Built a SaaS in 30 Days</span>
        <span className="wf-schedule-pill set">May 14 · 9:00 AM ✓</span>
      </div>
      <div className="wf-inline-row">
        <span className="wf-inline-row-name">Why Generalism is a Superpower</span>
        <span className="wf-schedule-pill">Schedule →</span>
      </div>
    </div>
  );
}
    ...
    <div className="wf-wrap">
      ...
      <nav className="wf-nav">
        <div className="wf-nav-inner">
          ...
          <span className="wf-logo" onClick={() => navigate('/')}>WriteFlow</span>
          <span className="wf-nav-pub">The WriteFlow Blog</span>
          <div className="wf-nav-right">
            <button className="wf-signin">Sign in</button>
            <button className="wf-getstarted">Get started</button>
          </div>
        </div>
      </nav>
      ...
      <div className="wf-page">
        ...
        <main className="wf-main">
          ...
          <div className="wf-body">
            <p>
              For writers juggling multiple drafts, ideas at different stages of readiness, and audiences spread across time zones, publishing on WriteFlow can feel like a balancing act. You know when a piece is ready — but finding the right moment to hit publish is a different challenge entirely. We want to make that easier.
            </p>
            <p>
              Starting today, all WriteFlow writers can schedule stories to publish automatically at a date and time of their choosing. Whether you want your piece to land on Monday morning when readers are fresh, or Friday afternoon when they have time to dig in, you're now in control.
            </p>

            <blockquote>
              <p>This feature is rolling out on May 12, 2026. If you don't see it on your dashboard yet, check back in a few days!</p>
            </blockquote>

            <h2>How to schedule a story</h2>

            <p>
              When you're ready to schedule a story, open the publish panel from the editor and select "Schedule for later" instead of "Publish now." You'll see a simple date and time picker — choose your preferred moment and confirm. That's it.
            </p>
            <p>
              You can edit or cancel a scheduled story at any time before it goes live. Head to your Stories dashboard, find any piece with a "Scheduled" label, and click to adjust. Nothing is locked in until it publishes.
            </p>
            ...
            <blockquote>
              <p>What's the difference between <strong>publishing</strong> and <strong>scheduling</strong>? Publishing sends your story live immediately. Scheduling queues it for a future date — your story won't be visible to readers until that moment arrives. Both options live inside the same publish panel.</p>
            </blockquote>

            <p>
              Scheduled stories are only visible to you until they go live. Your followers and readers won't see them, receive notifications, or find them via search until the scheduled time has passed.
            </p>
            <p>
              Finally: scheduling is entirely optional. If you prefer to publish spontaneously — or have already built a workflow that works for you — nothing changes. The "Publish now" button is still right there.
            </p>
            <p>
              Read more about story scheduling in the <a href="#">WriteFlow help center</a>.
            </p>

            <h2>What's next?</h2>
            <p>
              WriteFlow's writers are the reason this platform exists. While we can't write the stories for you, we can build better tools so you can spend less time managing logistics and more time doing the work you love. Story scheduling was one of the most-requested features we've heard over the past year — thank you to everyone who took the time to share feedback.
            </p>
            <p>
              This update also lays the groundwork for bigger publishing workflow improvements coming soon. Stay tuned for even more ways we hope to support your writing practice on WriteFlow.
            </p>
          </div>
          ...
          {recommendations.map((rec, i) => (
            <div key={i} className="wf-sb-rec">
              <div className="wf-sb-rec-pub">
                <span className="wf-sb-rec-dot">W</span> WriteFlow Staff
              </div>
      ...
      <footer className="wf-footer">
        <div className="wf-footer-inner">
          {["Help","Status","About","Careers","Press","Blog","Privacy","Rules","Terms","Text to speech"].map(l => (
            <span key={l} className="wf-footer-link">{l}</span>
          ))}
        </div>
      </footer>
